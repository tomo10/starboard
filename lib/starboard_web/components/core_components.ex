defmodule StarboardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StarboardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StarboardWeb.Gettext, "errors", msg, opts)
    end
  end
